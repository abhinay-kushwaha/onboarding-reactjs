  ...
  return (
    <div className='shadow h-20'>
      <div className='flex justify-between items-center p-2 sm:px-7 px-3'>
        <img className='hidden sm:block sm:h-16' src={logo} alt="logo" />
        ...
        <div className='flex justify-center items-center gap-4 font-semibold text-lg'>
          <Link className='text-sm sm:text-lg' to="/logIn">Login</Link>
         <Link to="/signUp" className='  text-white text-sm rounded-md p-2 px-3 button3d'> Get started</Link>
        </div>
      </div>
    </div>
  )
