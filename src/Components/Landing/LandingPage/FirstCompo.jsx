    ...
    <>
      ...
      <div className="relative flex flex-col justify-center items-center gap-4 md:h-[400px] h-2/3 lg:h-[500px] xl:h-[600px] 2xl:h-[700px] 3xl:h-[800px] 4xl:h-[900px]  rounded-lg  ">
        ...
        <h1 className="font-extrabold text-2xl md:text-4xl text-black text-center mt-5 z-10 text-wrap">
          <span className="bg-white px-2 rounded">Revolutionize</span> Your Management
        </h1>
        <p className="font-semibold text-xl md:text-2xl text-black text-center z-10 text-wrap">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
        <p className="text-lg md:text-xl text-center mt-4 text-black z-10 text-wrap">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa, illo velit! Eveniet est dignissimos quisquam esse. Excepturi reiciendis mollitia a.
        </p>
        <Link
          to="/signUp"
