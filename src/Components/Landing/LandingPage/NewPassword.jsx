  ...
  return (
    <div className="flex justify-center items-center p-2 my-10">
      <div className="w-full flex justify-center lg:justify-end items-center">
        <div data-aos="zoom-in" data-aos-duration="3000" className="border-2 border-gray-300 rounded-md p-5 max-w-96  w-full flex flex-col justify-center  shadow gap-2">
          <form onSubmit={handleSubmit}>
            ...
            <label className="text-xs px-1 font-semibold relative z-10 top-3 left-2 bg-white w-fit rounded-md" htmlFor="confirmPassword">
            ...
            <button type="submit" className={`buttonp w-full   text-white font-bold text-lg p-2 rounded-sm mt-4 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`} disabled={isSubmitting}>
