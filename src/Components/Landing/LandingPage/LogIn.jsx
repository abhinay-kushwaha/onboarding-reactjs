  ...
  return (
    <div className="flex justify-center items-center p-2 my-10">
      ...
      <div data-aos="zoom-in" data-aos-duration="3000" className="w-full flex p-2  lg:justify-start justify-center  items-center">
        <div className="border border-gray-300 rounded-md p-4 max-w-lg w-full flex flex-col shadow-lg ">
          <div className="sm:text-2xl text-xl font-bold flex flex-col  justify-center items-center -mb-7">
            <h1 className="text-gray-700 w-full flex justify-center gap-2 items-center ">
              <img className="w-12" src={login} alt="" /> Welcome to <strong className="text-[#544541]"> STREAMLINE</strong>
            </h1>
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <button className={` buttonp divide-purple-300 text-white font-bold text-lg p-1.5 rounded-sm mt-4 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
...
//         // navigate('/dashboard');
//       } else {
//         // Set the error message based on response status
//         if (response.status === 401) {
//           // setErrorMessage("Invalid credentials");
//           toast.error("Invalid credentials");
//         } else if (response.status === 404) {
//           // setErrorMessage("Mail not found");
...
//     } catch (error) {
//       console.error("Error:", error);
//       // setErrorMessage('An error occurred. Please try again later.'); // Set error for catch
//       toast.error("An error occurred. Please try again later."); // Set error for catch
//     }finally {
//       setIsSubmitting(false);
//     }
//   };
...
//           <div className="sm:text-2xl text-xl font-bold flex flex-col  justify-center items-center -mb-7">
//             <h1 className="text-gray-700 w-full flex justify-center gap-2 items-center ">
//               <img className="w-12" src={login} alt="" /> Welcome to <strong className="text-[#27B4A8]"> STREAMLINE</strong>
//             </h1>
//             {/* <h1 className='text-sm font-normal w-full flex justify-center items-center '>
//           To get started, please sign in
//           </h1> */}
